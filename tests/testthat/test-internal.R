...
test_that(".is_not_empty_* do what I want them to", {
  ...
  expect_false ( .is_not_empty_integer ( "i"           ) )
  expect_false ( .is_not_empty_integer ( NA            ) )
  expect_false ( .is_not_empty_integer ( NA_integer_   ) )
  expect_false ( .is_not_empty_integer ( NULL          ) )
  expect_false ( .is_not_empty_integer ( integer(0)    ) )
  expect_true  ( .is_not_empty_integer ( 42L           ) )
  expect_true  ( .is_not_empty_integer ( 0L            ) )
  expect_true  ( .is_not_empty_integer ( -42L          ) )
  expect_true  ( .is_not_empty_integer ( 1:5           ) )
