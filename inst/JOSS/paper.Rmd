...
in R. rmonad enhances the `magrittr` functionality by providing X, Y Z.
(branching, error/warning/log message capture, and traceback with stored
values).  While magrittr provides pipe-based pipelines, R provides
documentation and debugging of those pipelines. 

Monad referecne: [@wadler1995monads]
