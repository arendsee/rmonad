...
The `%__%` operator is a little like a semicolon, in that it demarcates
...
any analysis and recompose it as `%v__%` delimited blocks. The result of
running the analysis would be a data structure containing all results and
errors.
